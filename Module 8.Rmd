---
title: "Module 8"
author: "Chatziioannou Ioanna Elissavet"
...
confusionMatrix(decisionTreePrediction, factor(testingDataSet$classe))
```
...
confusionMatrix(randomForestPrediction, factor(testingDataSet$classe))
```
